...
namespace kodi { namespace addon { class CInstanceNetplay; }}

extern "C"
{
  /// @name Netplay Data Stream API
  ///{

/*!
 * \brief Capabilities of the data stream, available before creation
 */
struct data_stream_capabilities
{
  /*!
...
struct data_stream_properties
{
   ...
   */
  unsigned int max_packet_lifetime_ms;
   ...
   */
  unsigned int buffered_amount_low_threshold;
};

/*!
 * \brief Measured properties about the data stream
 */
struct data_stream_diagnostics
{
  /*!
...
{
  /*!
   * \brief Current state of the data stream
   */
  bool open;
...
typedef struct AddonToKodiFuncTable_kodi_filesystem
{
  ...
  public:
     ...
     */
    virtual bool GetProperties(data_stream_properties& props) = 0;
     ...
     */
    virtual bool GetDiagnostics(data_stream_diagnostics& diags) = 0;
  };

  /*!
   * \brief Outgoing data stream abstraction
   */
  class Idata_stream_output : public IDataStream
  {
  public:
    ~Idata_stream_output() override = default;
   ...
   */
  class Idata_stream_input: public IDataStream
  {
  public:
    ~Idata_stream_input() override = default;
