...
void CApplication::Stop(int exitCode)
{
  ...
  try
  {
    ...
    m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::System, "xbmc", "OnQuit", vExitCode);
...
void CApplication::OnPlayBackEnded()
{
  ...
  data["end"] = true;
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnStop", m_itemCurrentFile, data);
...
void CApplication::OnPlayBackPaused()
{
  ...
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnPause", m_itemCurrentFile, param);
}
...
void CApplication::OnPlayBackResumed()
{
  ...
  param["player"]["playerid"] = CServiceBroker::GetPlaylistPlayer().GetCurrentPlaylist();
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnResume", m_itemCurrentFile, param);
}
...
void CApplication::OnPlayBackSpeedChanged(int iSpeed)
{
  ...
  param["player"]["playerid"] = CServiceBroker::GetPlaylistPlayer().GetCurrentPlaylist();
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnSpeedChanged", m_itemCurrentFile, param);
}
...
void CApplication::OnPlayBackSeek(int64_t iTime, int64_t seekOffset)
{
  ...
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnSeek", m_itemCurrentFile, param);
...
void CApplication::OnAVStarted(const CFileItem &file)
{
  ...
  param["player"]["speed"] = 1;
  param["player"]["playerid"] = CServiceBroker::GetPlaylistPlayer().GetCurrentPlaylist();
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnAVStart", m_itemCurrentFile, param);
}
...
void CApplication::OnAVChange()
{
  ...
  param["player"]["speed"] = 1;
  param["player"]["playerid"] = CServiceBroker::GetPlaylistPlayer().GetCurrentPlaylist();
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnAVChange", m_itemCurrentFile, param);
}
...
bool CApplication::ToggleDPMS(bool manual)
{
  if (manual || (m_dpmsIsManual == manual))
  {
    if (m_dpmsIsActive)
    {
      ...
      SetRenderGUI(true);
      m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::GUI, "xbmc", "OnDPMSDeactivated");
    ...
    else
    {
      if (m_dpms->EnablePowerSaving(m_dpms->GetSupportedModes()[0]))
      {
        ...
        SetRenderGUI(false);
        m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::GUI, "xbmc", "OnDPMSActivated");
        return true;
      }
    }
  }
...
bool CApplication::WakeUpScreenSaverAndDPMS(bool bPowerOffKeyPressed /* = false */)
{
  ...
  if(result)
  {
    ...
    m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::GUI, "xbmc", "OnScreensaverDeactivated", data);
  }
...
void CApplication::ActivateScreenSaver(bool forceType /*= false */)
{
  ...
  m_screensaverActive = true;
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::GUI, "xbmc", "OnScreensaverActivated");
  ...
  case GUI_MSG_PLAYBACK_STARTED:
    {
      ...
      param["player"]["speed"] = 1;
      param["player"]["playerid"] = CServiceBroker::GetPlaylistPlayer().GetCurrentPlaylist();
      m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Player, "xbmc", "OnPlay", m_itemCurrentFile, param);
...
void CApplication::VolumeChanged()
{
  ...
  data["muted"] = m_muted;
  m_ServiceManager->GetAnnouncementManager().Announce(ANNOUNCEMENT::Application, "xbmc", "OnVolumeChanged", data);
