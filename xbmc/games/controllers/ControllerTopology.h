...
public:
   ...
   */
  const std::vector<ControllerID> &Accepts() const { return m_accepts; }
   ...
   */
  bool IsCompatible(const std::string &controllerId, const std::string &modelName = "") const;

  bool Deserialize(const TiXmlElement* pElement);

private:
  std::string m_portId;
  std::vector<ControllerID> m_accepts;
};
...
public:
   ...
   */
  bool HasPlayer() const { return m_bHasPlayer; }
