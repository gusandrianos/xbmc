...
namespace JOYSTICK
{
  ...
  public:
     ...
     * \param center      The center point of the axis
     * \param range       The maximum distance the axis can move
     *
     * \return True if the motion was handled, false otherwise
     */
    virtual bool OnAxisMotion(unsigned int axisIndex, float position, float center, float range) = 0;
